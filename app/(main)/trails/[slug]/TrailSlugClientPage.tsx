...
export default function TrailSlugClientPage({ trail }: { trail: Trail }) {
  ...
  if (!icons) {
    return <div className="flex justify-center items-center" style={{ minHeight: 'calc(100vh - 200px)' }}>
  ...
  return (
    <div className="bg-white">
      <div className="w-full bg-white pt-8 pb-4">
        {/* ... (JSX remains the same, but now use icons.trailIcon and icons.userIcon) ... */}
        {/* Example: <Marker position={trail.coords} icon={icons.trailIcon}> */}
